...
import { List, ListItem, Typography, useTheme, GridList, GridListTile, Dialog, DialogContent } from '@material-ui/core';
...
export const ImgInPost = (props: IImgInPostProps) => {
    ...
    return (
        <div>            
            ...
            <Dialog open={openDialog} fullWidth maxWidth={false} onClose={() => {setOpenDialog(false); setBigImagePath("")}}>
                <DialogContent>
                    <img  
