...
export const TapeElement = connect((state: RootState) => ({ avatarUrlUid: state.userPersonalsReducer.avatarUrlUid, userRole: state.authReducer.entityType, token: state.authReducer.token }))(TapeElementCardComp);