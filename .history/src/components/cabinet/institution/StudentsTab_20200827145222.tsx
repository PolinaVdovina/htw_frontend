        ...
        if (props.token) { 
            await tapeFetcherContext?.fetchNext(
                (lastPostDate, count) => searchCriteriaFetch("/employee/getBySearchCriteria", props.token, {
                        searchCriteria: [searchCriteria("institution", cabinetContext.login, SearchCriteriaOperation.EQUAL),
...
export const EmployeesTab = connect(mapStateToProps)(StudentsTabComp);