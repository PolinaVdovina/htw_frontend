import { useTheme, Grid, Dialog, DialogTitle, DialogActions, Button, Divider, Paper } from '@material-ui/core';
...
import { deleteEntity, searchCriteriaFetch } from '../../utils/fetchFunctions';
        ...
        if (props.token) {
            await tapeFetcherContext?.fetchNext(
                (lastPostDate, count) => {
                    ...
                    return searchCriteriaFetch("/api/chat/getChatList/" + props.login, props.token, {
                        searchCriteria: [
